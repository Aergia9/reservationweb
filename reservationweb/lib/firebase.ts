...
// Initialize Firebase services with the correct database ID "event"
const auth = getAuth(app);
const db = getFirestore(app, "event"); // Specify the database ID "event"
const storage = getStorage(app);

console.log("✅ Firebase initialized with database ID: event");
